...
def gatekeeper(login):
  if login == "admin": return "You have the privileges."
  elif login =="user": return "You have limited privileges."
  else: return "You have no privileges"
  

# 3. Call the gatekeeper function with a string and print what it returns.
print(gatekeeper("admin"))
print(gatekeeper("user"))
print(gatekeeper("guest"))
...
def check_balance(loan_balance):
  if(loan_balance>=0)return "you don't owe any money"
  else return f"you owe ${-loan_balance}"
